...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form role="form" method="POST" action="{{ route('movies.update', $movie->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" class="form-control select2" name="category_ids[]" id="sports">
                                            @foreach($categories as $category)
                                                <option @if(in_array($category->id, $arrayCategories)) selected @endif value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="url_video" value="{{ $movie->url_video }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="content">{{ $movie->content }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Number view</label>
                                        <input class="form-control" min="0" type="number" name="number_view" value="{{ $movie->number_view }}">
                                    </div>
                                </div>
                            </div>
                        </div>
