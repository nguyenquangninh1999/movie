...
{{--            </li>--}}
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'movies') == true ? 'active' : '' }}" href="{{ route('movies.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'categories') == true ? 'active' : '' }}" href="{{ route('categories.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'chats') == true ? 'active' : '' }}" href="{{ route('chats.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
